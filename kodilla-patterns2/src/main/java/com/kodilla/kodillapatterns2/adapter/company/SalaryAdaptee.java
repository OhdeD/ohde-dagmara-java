...
import com.kodilla.kodillapatterns2.adapter.company.newhrsystem.CompanySallaryProcessor;
...
public class SalaryAdaptee implements SalaryProcessor {
    ...
    public BigDecimal calculateSalaries(List<Employee> employees) {
        CompanySallaryProcessor theProcessor = new CompanySallaryProcessor();
